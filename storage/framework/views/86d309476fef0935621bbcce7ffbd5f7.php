<aside class="sidebar" aria-label="Primary">
    ...
    <nav class="sidebar-nav" aria-label="Sections">
        ...
        <a class="nav-link <?php echo e(request()->routeIs('files.*') ? 'active' : ''); ?>" href="<?php echo e(route('files.index')); ?>">
        ...
        <a class="nav-link <?php echo e(request()->routeIs('favorites') ? 'active' : ''); ?>" href="<?php echo e(route('favorites')); ?>">
            <i data-lucide="star" aria-hidden="true"></i>Favorites
        </a>
        <a class="nav-link <?php echo e(request()->routeIs('recent') ? 'active' : ''); ?>" href="<?php echo e(route('recent')); ?>">
            <i data-lucide="clock" aria-hidden="true"></i>Recent
        </a>
        <a class="nav-link <?php echo e(request()->routeIs('trash') ? 'active' : ''); ?>" href="<?php echo e(route('trash')); ?>">
...
<?php /**PATH C:\laragon\www\infinitg\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>