    ...
    <div class="modal" role="dialog" aria-modal="true" aria-labelledby="upload-title">
        ...
        <div class="upload-panel">
            <label class="dropzone" for="upload-file" data-drop-target="upload-file">
                ...
                <span>Up to <?php echo e(ceil(config('infinitg.max_upload_kb') / 1024)); ?> MB per file &middot; JPG, PNG, PDF, ZIP, DOC and more</span>
            </label>
            ...
            <div class="modal-foot">
                ...
                <button class="btn btn-primary" type="button" id="upload-start" data-url="<?php echo e(route('upload')); ?>" disabled>
...
<?php /**PATH C:\laragon\www\infinitg\resources\views/partials/modals.blade.php ENDPATH**/ ?>